      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 hidden w-full px-6 pb-3 md:block lg:px-8">
        <div className="w-full rounded-2xl border border-black/10 bg-[#e6e6e9] px-6 py-5 shadow-[0_-14px_36px_rgba(15,23,42,0.14)] lg:mx-auto lg:max-w-6xl lg:rounded-xl lg:px-5 lg:py-3">
          <div className="grid items-center justify-items-center gap-5 lg:grid-cols-[minmax(0,1fr)_auto] lg:gap-6">
            ...
            <div className="grid w-full max-w-[680px] gap-3 md:grid-cols-2 lg:min-w-[520px] xl:min-w-[560px]">
              <a
                href={whatsappUrl("Olá, quero falar com um consultor da NR Cozinhas.")}
                target="_blank"
                rel="noopener noreferrer"
                className="whatsapp-pulse inline-flex min-h-14 items-center justify-center gap-2 rounded-[0.6rem] bg-[#1f8f5b] px-6 text-base font-semibold !text-[#f4f6fb] transition hover:bg-[#17784b] lg:min-h-11 lg:px-5 lg:text-sm"
                style={{ color: "#f4f6fb" }}
              >
              ...
              <a
                href="#orcamento"
                className="inline-flex min-h-14 items-center justify-center gap-2 rounded-[0.6rem] bg-[#152a6c] px-6 text-base font-semibold !text-[#f4f6fb] transition hover:bg-[#102155] lg:min-h-11 lg:px-5 lg:text-sm"
                style={{ color: "#f4f6fb" }}
              >
